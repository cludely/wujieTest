  ...
  function shimPeerConnection$2(window, browserDetails) {
    ...
    if (browserDetails.version < 53) {
      ["setLocalDescription", "setRemoteDescription", "addIceCandidate"].forEach(function (method) {
        ...
        const methodObj = {
          [method]() {
            arguments[0] = new (method === "addIceCandidate" ? window.RTCIceCandidate : window.RTCSessionDescription)(
              arguments[0]
            );
  ...
  class MediaStreamFactory {
    ...
    static createMediaStream(constraints) {
      ...
      if (
        ...
        return Promise.reject(
          new TypeError("Cannot capture video from screen cast while capture audio from" + " other source.")
        );
